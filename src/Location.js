			...
			<div className="container-fluid col-md-10 col-md-offset-1">
				...
				<div className="">
			        ...
			        <div>
			            ...
			            <div className="tags">
			                <span className="btn-danger"><a href="#">energy</a></span><span className="btn-danger"><a href="#">reality</a></span><span className="btn-danger"><a href="#">world</a></span>
			            </div>    
			        </div> 
